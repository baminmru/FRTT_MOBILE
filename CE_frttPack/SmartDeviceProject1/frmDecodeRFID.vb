...
Public Class frmDecodeRFID
    ...
    Shared strTagID As String = String.Empty
    Shared Sub OnSaveReady(ByVal ar As System.IAsyncResult)
    Try
        strTagID = ss.EndEncodeTag(ar)
        resultOK = True
    ...
    Private Sub ProcessTags(ByVal Tag__1 As IEnumerable(Of Symbol.RFID3.TagData))
        ...
        Try
            ...
            If Not maxRSSI_Tag Is Nothing Then
                ...
                Else
                    Try
                        If strTagID.Substring(1, 12) <> txtTagID.Text.Substring(1, 12) Then
                            QTag = True
                        End If
                    Catch ex As Exception
                        QTag = True
                ...
                If QTag Then
                    ...
                    lblStatus.Text = "Запрос к серверу " & strTagID.Substring(1, 12)
                    Application.DoEvents()
                    Dim cb As AsyncCallback
                    cb = New AsyncCallback(AddressOf OnSaveReady)
                    resultOK = False
                    ss.BeginEncodeTag(strTagID, cb, Nothing)
                    Dim cnt As Integer
                    cnt = 30
                    While cnt > 0
    ...
    Private Sub cmdChangeFilter_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdChangeFilter.Click
    ...
    Private Sub cmdClearTagID_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdClearTagID.Click
        txtTagID.Text = ""
    End Sub
End Class